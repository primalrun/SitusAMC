...
# download web file list
file_list = [
['sites/documents/hecmsfsnap122012.xls', 2012, 12]
,['sites/documents/hecmsfsnap1112.xls', 2012, 11]
,['sites/documents/hecmsfsnap102012.xls', 2012, 10]
,['sites/documents/hecmsfsnap0912.xls', 2012, 9]
,['sites/documents/hecmsfsnap0812.xls', 2012, 8]
,['sites/documents/hecmsfsnap0712.xls', 2012, 7]
,['sites/documents/hecmsfsnap0612.xls', 2012, 6]
,['sites/documents/hecmsfsnap0512.xls', 2012, 5]
,['sites/documents/hecmsfsnap0412.xls', 2012, 4]
,['sites/documents/hecmsfsnap0312.xls', 2012, 3]
,['sites/documents/hecmsfsnap0212.xls', 2012, 2]
,['sites/documents/hecmsfsnap0112.xls', 2012, 1]
]
...
for file_row in file_list:
    ...
    # nmls = list(df_data['NMLS_ID'].unique())
    # for n in nmls:
    #     print(n)
    # sys.exit()
    ...
    with conn01.cursor() as cursor:
        ...
        print(f'{download_file} ({file_year}, {file_month}) completed successfully')
