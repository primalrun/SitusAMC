...
target_schema = 'stage'
ncreif_source_file = r'C:\Users\jasonwalker\OneDrive - SitusAMC\Documents\project\PERFORMANCE_ATTRIBUTION\2022Q4\SOURCE_FILES\NCREIF Data 4Q22.xlsx'
quarter_search = '4Q22'
...
ncreif_subject = {
    'PropType': 'IMPORT_NCREIF_PROPTYPE'
    , 'SubType': 'IMPORT_NCREIF_SUBTYPE'
    , 'Region': 'IMPORT_NCREIF_REGION'
    , 'Division': 'IMPORT_NCREIF_DIVISION'
    , 'CBSAorDIV': 'IMPORT_NCREIF_CBSADIV'
    , 'State': 'IMPORT_NCREIF_STATE'
}
...
sheet_search = [s + quarter_search for s in ncreif_subject]
